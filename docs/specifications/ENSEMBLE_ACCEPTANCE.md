...
| Web-worker ensemble | ChatGPT Web and Claude Web produce independent subscription-backed architecture candidates, a synthesizer accepts the design, and Claude Web can fall back to an API Worker. |
