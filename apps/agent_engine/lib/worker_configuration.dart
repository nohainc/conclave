...
class WorkerConfigurationStore {
  ...
  Map<String, Object?> _validate(Map<String, Object?> raw) {
    ...
    final itemAgentId = _requiredString(raw, 'agentId');
    if (itemWorkspaceId != workspaceId || itemAgentId != agentId) {
      throw StateError('desired Worker belongs to another Agent or workspace');
    }
