...
/// Shared Conclave AX design tokens and theme system for Conclave Workspace.
abstract final class ConclaveBrand {
  ...
  /// Builds the light [ThemeData] for Conclave Workspace.
  ...
  /// Builds the dark [ThemeData] for Conclave Workspace.
