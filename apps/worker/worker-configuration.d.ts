/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc apps/worker/worker-configuration.d.ts` (hash: d76db8a5f27589d7e67e4fef54da3f9b)
