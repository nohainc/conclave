/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc apps/worker/worker-configuration.d.ts` (hash: aa2a679484958a3aaf327dd05ad68a60)
