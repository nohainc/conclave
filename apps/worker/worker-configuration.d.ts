/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc apps/worker/worker-configuration.d.ts` (hash: 1bed06dde92492c57601a81815c04013)
