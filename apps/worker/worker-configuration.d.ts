/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc apps/worker/worker-configuration.d.ts` (hash: 24774d7b9408bade6c4cf8a2bb28c903)
...
interface __BaseEnv_Env {
	...
	CONCLAVE_RUNTIME_CONNECTION: DurableObjectNamespace;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONCLAVE_ENVIRONMENT">> {}
}
