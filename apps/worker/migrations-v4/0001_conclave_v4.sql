...
CREATE TABLE credential_profiles (
  ...
  secret_location TEXT NOT NULL CHECK (secret_location IN ('none', 'host_secure_store', 'cloud_vault_reference')),
  secret_reference TEXT,
  status TEXT NOT NULL CHECK (status IN ('ready', 'needs_auth', 'invalid', 'expired', 'revoked')),
