...
const routeHandlers = {
  ...
  handleAgentGatewayConnect: handlers.handleAgentGatewayConnect,
  handleAgentProtocolMessage: handlers.handleAgentProtocolMessage,
  handleEnrollAgent: handlers.handleEnrollAgent,
  handleListAgentEnrollments: handlers.handleListAgentEnrollments,
  handleCreateAgentEnrollment: handlers.handleCreateAgentEnrollment,
  handleRevokeAgentEnrollment: handlers.handleRevokeAgentEnrollment,
  handleListAgents: handlers.handleListAgents,
  handleGetAgent: handlers.handleGetAgent,
  handleRevokeAgent: handlers.handleRevokeAgent,
  handleAnnounceAgentUpdate: handlers.handleAnnounceAgentUpdate,
  ...
  handleGetLatestAgentRelease: handlers.handleGetLatestAgentRelease,
  handlePublishAgentRelease: handlers.handlePublishAgentRelease,
  handleDownloadAgentRelease: handlers.handleDownloadAgentRelease,
  handleRevokeAgentRelease: handlers.handleRevokeAgentRelease,
  handleGetAgentRelease: handlers.handleGetAgentRelease,
